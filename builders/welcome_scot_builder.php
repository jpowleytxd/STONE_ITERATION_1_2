...
for($i = 1; $i <= 3; $i++){
  foreach(glob("../sites/*/templates/*_branded.html") as $filename){
    ...
    $linkInsert = '<a href="http://stonegateemail.co.uk/$dynamic3$/website" style="color: ' . $textColor . '"><span ="text-decoration: underline; color: ' . $textColor . ';">click here</span></a>';
