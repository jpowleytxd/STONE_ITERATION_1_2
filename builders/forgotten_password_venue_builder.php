...
foreach(glob("../sites/*/templates/*_venue.html") as $filename){
  ...
  $link = '<a href="http://stonegateemail.co.uk/$dynamic3$/website" style="color: ' . $textColor . ';"><span style="text-decoration: underline; color: ' . $textColor . ';">Click here</span></a>';
