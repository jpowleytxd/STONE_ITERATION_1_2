...
foreach(glob("../sites/*/templates/*_branded.html") as $filename){
  ...
  $linkInsert = '<a href="http://stonegateemail.co.uk/$dynamic3$/party" style="color: ' . $textColor . '; font-weight: bold;"><span style="text-decoration: underline; color: ' . $textColor . ';">Find out how we can make it your best ever.</span></a>';
